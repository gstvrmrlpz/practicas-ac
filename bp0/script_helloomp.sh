...
echo "1. Ejecución hola.sh una vez sin cambiar nº de hebras (valor por defecto):"
srun c/HelloOMP

echo "2. Ejecución hola.sh varias veces con distinto nº de hebras:"
